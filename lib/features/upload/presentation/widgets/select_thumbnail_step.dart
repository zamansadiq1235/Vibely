            ...
            children: [
              if (video.thumbnailUrl != null)
                CachedNetworkImage(
                  ...
                  fit: BoxFit.cover,
                  // Decode at roughly the tile's on-screen size rather
                  // than the thumbnail's native resolution — grids can
                  // hold dozens of these at once, so this is the single
                  // biggest memory win available without a CDN that
                  // serves pre-resized images (spec §1's "future
                  // integration with a dedicated video streaming/CDN
                  // solution" is the natural place to do this properly).
                  memCacheWidth: 360,
